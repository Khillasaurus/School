#ifndef INCLUDED_BLASTOIDS_GAME_H
#define INCLUDED_BLASTOIDS_GAME_H
...
// Description:	Game class for game state.
//=================================================================================================
...
private:
	...
	// Mouse
	 // Render Offset
	  // X
	CFont mFontRenderOffsetX;
	char mFontRenderOffsetXTextBuff[64];
	  // Y
	CFont mFontRenderOffsetY;
	char mFontRenderOffsetYTextBuff[64];
	#endif//#if DSDEBUGMODE == 1
};

#endif // #ifndef INCLUDED_BLASTOIDS_GAME_H
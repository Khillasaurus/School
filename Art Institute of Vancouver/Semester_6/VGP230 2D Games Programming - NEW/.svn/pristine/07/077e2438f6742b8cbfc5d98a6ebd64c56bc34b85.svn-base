...
void Game::Load()
{
	...
	// Mouse
	 // Render Offset
	  // X
	sprintf_s(mFontRenderOffsetXTextBuff, "Render Offset X: %d", 0);
	mFontRenderOffsetX.Create(FontType::GARAMOND, 24, false, false);
	mFontRenderOffsetX.SetColor(25, 155, 144);
	mFontRenderOffsetX.SetTextArea(0, 0, kScreenWidth, kScreenHeight);
	  // Y
	sprintf_s(mFontRenderOffsetYTextBuff, "Render Offset Y: %d", 0);
	mFontRenderOffsetY.Create(FontType::GARAMOND, 24, false, false);
	mFontRenderOffsetY.SetColor(25, 155, 144);
	mFontRenderOffsetY.SetTextArea(0, 0, kScreenWidth, kScreenHeight);
...
void Game::Unload()
{
	...
	// Mouse
	 // Render Offset
	  //X
	mFontRenderOffsetX.Destroy();
	  //Y
	mFontRenderOffsetY.Destroy();
	#endif//#if DSDEBUGMODE == 1
}
...
int Game::Update(float deltaTime)
{
	...
	{
		//Character
		mCharacter.Update(deltaTime, mMap, mRenderOffset);
	}
	...
	// Mouse
	 // Render Offset
	  //X
	sprintf_s(mFontRenderOffsetXTextBuff, "Render Offset X: %f", mRenderOffset.x);
	  //Y
	sprintf_s(mFontRenderOffsetYTextBuff, "Render Offset Y: %f", mRenderOffset.y);
	#endif//#if DSDEBUGMODE == 1
...
void Game::Render()
{
	...
	// Mouse
	 // Render Offset
	  //X
	mFontRenderOffsetX.PrintText(mFontRenderOffsetXTextBuff, 0, 96);
	  //Y
	mFontRenderOffsetY.PrintText(mFontRenderOffsetYTextBuff, 0, 128);
	#endif//#if DSDEBUGMODE == 1
}

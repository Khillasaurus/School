...
void movement(int &, int &, int, int &, int &, int [], int [], int [][8]);//randomly moves the knight to an untravelled location on the board with it's maximum of 8 movement options
...
int main()
{
    ...
    for (int n = 0; n < 1000; ++n)//thousand tour count
    {
        ...
        {
            movement(moveCounter, moveSuccesful, moveNumber, currentColumn, currentRow, horizontal, vertical, board);
...
void movement(int &moveCounter, int &moveSuccesful, int moveNumber, int &currentColumn, int &currentRow, int horizontal[], int vertical[], int board[][8])
{

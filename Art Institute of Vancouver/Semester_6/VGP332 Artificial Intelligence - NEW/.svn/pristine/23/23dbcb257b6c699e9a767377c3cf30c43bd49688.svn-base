...
void Gameplay::Load()
{
	...
	*/
	...
	// World
	mWorld.AddWall(SVector2(100.0f, 100.0f), SVector2(700.0f, 100.0f));
	mWorld.AddWall(SVector2(700.0f, 100.0f), SVector2(700.0f, 500.0f));
	mWorld.AddWall(SVector2(700.0f, 500.0f), SVector2(100.0f, 500.0f));
	mWorld.AddWall(SVector2(100.0f, 500.0f), SVector2(100.0f, 100.0f));
...
void Gameplay::AISearch(Search::eSearchType searchType)
{
	const int kTileWidth = mMap.GetTileSize();
	const int kTileHeight = mMap.GetTileSize();
	const int kColumnCount = mMap.GetColumns();
...
void Gameplay::AIRender(const SVector2& offset)
{
	// Waypoints
	 //Start
...
void Gameplay::SetWaypointStartPos(const SVector2& pos)
{
...
void Gameplay::SetWaypointEndPos(const SVector2& pos)
{
	//Not a guaranteed safety check, but it does eliminate some invalid values immediately
	if( pos.x >= 0 &&
		pos.x < mGraph.GetNumNodes() &&

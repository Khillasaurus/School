...
public class UnitMoveNode : MonoBehaviour
{
	//===---Public---===
	...
	void Start()
	{
		...
		rigidbody.position.Set(waypointList[0].transform.position.x, waypointList[0].transform.position.y, waypointList[0].transform.position.z);
		...
		transform.rigidbody.position.Set(waypointList[0].transform.position.x,
										 waypointList[0].transform.position.y,
										 waypointList[0].transform.position.z);

		from.Set(waypointList[0].transform.position.x,
				 waypointList[0].transform.position.y,
				 waypointList[0].transform.position.z);

		to.Set( waypointList[1].transform.position.x,
				waypointList[1].transform.position.y,
				waypointList[1].transform.position.z);
	}
	...
	void FixedUpdate()
	{
		testVelocity.Set(rigidbody.velocity.x, rigidbody.velocity.y, rigidbody.velocity.z);
		...
		if(mMoving)
		{
			...
			else
			{
				...
				from.Set(waypointList[mLastWaypointReachedCount].transform.position.x,
						 waypointList[mLastWaypointReachedCount].transform.position.y,
						 waypointList[mLastWaypointReachedCount].transform.position.z);

				to.Set( waypointList[mLastWaypointReachedCount + 1].transform.position.x,
						waypointList[mLastWaypointReachedCount + 1].transform.position.y,
						waypointList[mLastWaypointReachedCount + 1].transform.position.z);

...
public class TicTacToe { 
	...
	public static void Player1Turn(String Grid[][]){ 
		...
		if ((row == 1)&&(coloumn == 1)&&(Grid[0][0] != "[X]")&&(Grid[0][0] != "[O]")){ 
			Grid[0][0] = "[X]"; 
			DrawGrid(Grid); 
		} 
		if ((row == 2)&&(coloumn == 1)&&(Grid[1][0] != "[X]")&&(Grid[1][0] != "[O]")){ 
			Grid[1][0] = "[X]"; 
			DrawGrid(Grid); 
		} 

		if ((row == 3)&&(coloumn == 1)&&(Grid[2][0] != "[X]")&&(Grid[2][0] != "[O]")){ 
			Grid[2][0] = "[X]"; 
			DrawGrid(Grid); 
		} 
		if ((row == 1)&&(coloumn == 2)&&(Grid[0][1] != "[X]")&&(Grid[0][1] != "[O]")){ 
			Grid[0][1] = "[X]"; 
			DrawGrid(Grid); 
		} 

		if ((row == 2)&&(coloumn == 2)&&(Grid[1][1] != "[X]")&&(Grid[1][1] != "[O]")){ 
			Grid[1][1] = "[X]"; 
			DrawGrid(Grid); 
		} 
		if ((row == 3)&&(coloumn == 2)&&(Grid[2][1] != "[X]")&&(Grid[2][1] != "[O]")){ 
			Grid[2][1] = "[X]"; 
			DrawGrid(Grid); 
		} 

		if ((row == 1)&&(coloumn == 3)&&(Grid[0][2] != "[X]")&&(Grid[0][2] != "[O]")){ 
			Grid[0][2] = "[X]"; 
			DrawGrid(Grid); 
		} 
		if ((row == 2)&&(coloumn == 3)&&(Grid[1][2] != "[X]")&&(Grid[1][2] != "[O]")){ 
			Grid[1][2] = "[X]"; 
			DrawGrid(Grid); 
		} 

		if ((row == 3)&&(coloumn == 3)&&(Grid[2][2] != "[X]")&&(Grid[2][2] != "[O]")){ 
			Grid[2][2] = "[X]";
			DrawGrid(Grid);
		} 
		BoxesFilled++;
	...
	public static void ComputerTurn(String Grid[][]){ 
		int random = 0; 
		int situation = 0; 
		random = randomGenerator.nextInt(8)+1; 
		boolean smart = false; 
	...
	public static void WinGame(String Grid[][]){ 
		...
		if((Grid[2][0]=="[O]") && (Grid[2][1]=="[O]") && Grid[2][2]=="[O]"){ 
			System.out.println("Player 2 wins!!! XD"); 
			BoxesFilled=9; 
		} 
		/*[ ][ ][ ] 
		 *[ ][ ][ ] 
		...
		if((Grid[0][2]=="[X]") && (Grid[1][2]=="[X]") && Grid[2][2]=="[X]"){ 
			System.out.println("Player 1 wins! yay =)"); 
			BoxesFilled=9; 
		} 
		/*[ ][ ][X] 
		 *[ ][ ][X] 
		...
		if((Grid[0][2]=="[O]") && (Grid[1][2]=="[O]") && Grid[2][2]=="[O]"){ 
			System.out.println("Player 2 wins! |lol| =P"); 
			BoxesFilled=9; 
		} 
		/*[ ][ ][O] 
		 *[ ][ ][O] 

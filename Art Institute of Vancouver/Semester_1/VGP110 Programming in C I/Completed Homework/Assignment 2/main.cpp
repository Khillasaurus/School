...
//    int accuracy = 5; //a limiter placed on the supposed-to-be never ending loop to prevent values from exceeding the maximum value for a float data type
//
